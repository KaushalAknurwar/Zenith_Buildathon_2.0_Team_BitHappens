      ...
      <div className="space-y-4">
        <TooltipProvider>
          <div className="flex items-center justify-between p-4 rounded-lg bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-all duration-300">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Switch checked={settings.isPublic} onCheckedChange={(checked) => onSettingChange('isPublic', checked)} className="data-[state=checked]:bg-primary flex-shrink-0"/>
              </TooltipTrigger>
              <TooltipContent>
          ...
          <div className="flex items-center justify-between p-4 rounded-lg bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-all duration-300">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Switch checked={settings.shareMoodHistory} onCheckedChange={(checked) => onSettingChange('shareMoodHistory', checked)} className="data-[state=checked]:bg-duo-blue flex-shrink-0"/>
              </TooltipTrigger>
              <TooltipContent>
          ...
          <div className="flex items-center justify-between p-4 rounded-lg bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-all duration-300">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Switch checked={settings.showActivityStatus} onCheckedChange={(checked) => onSettingChange('showActivityStatus', checked)} className="data-[state=checked]:bg-duo-green flex-shrink-0"/>
              </TooltipTrigger>
              <TooltipContent>
