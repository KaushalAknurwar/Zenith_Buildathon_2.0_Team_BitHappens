...
const ProfilePage = () => {
    ...
    return (<div className="container mx-auto p-6 space-y-8 max-w-7xl">
      ...
      <Card className="bg-white/10 backdrop-blur-lg border-white/20 p-6 overflow-hidden">
        <PrivacySettings settings={privacySettings} onSettingChange={handleSettingChange}/>
      </Card>
      ...
      <Card className="bg-white/10 backdrop-blur-lg border-white/20 overflow-hidden">
        <Tabs defaultValue="drawings" className="w-full">
          <TabsList className="grid w-full grid-cols-4 gap-4 p-4">
            <TabsTrigger value="drawings" className="data-[state=active]:bg-primary data-[state=active]:text-white transition-all duration-300 truncate">
              <MessageSquare className="w-4 h-4 mr-2 flex-shrink-0"/>
              <span className="truncate">Drawings</span>
            </TabsTrigger>
            <TabsTrigger value="thoughts" className="data-[state=active]:bg-duo-blue data-[state=active]:text-white transition-all duration-300 truncate">
              <MessageSquare className="w-4 h-4 mr-2 flex-shrink-0"/>
              <span className="truncate">Thoughts</span>
            </TabsTrigger>
            <TabsTrigger value="voice" className="data-[state=active]:bg-duo-green data-[state=active]:text-white transition-all duration-300 truncate">
              <Mic className="w-4 h-4 mr-2 flex-shrink-0"/>
              <span className="truncate">Voice</span>
            </TabsTrigger>
            <TabsTrigger value="video" className="data-[state=active]:bg-duo-orange data-[state=active]:text-white transition-all duration-300 truncate">
