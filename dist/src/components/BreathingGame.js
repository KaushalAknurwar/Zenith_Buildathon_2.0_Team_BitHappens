    ...
    return (<div className="container mx-auto p-6">
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <Card className="p-8 space-y-6">
          <div className="text-center space-y-4">
            <div className={`text-2xl font-semibold transition-colors duration-300 ${phase === 'inhale' ? 'text-blue-500' :
          ...
          <div className="relative h-48 flex items-center justify-center">
            <div className={`absolute w-48 h-48 rounded-full transition-all duration-300 ${phase === 'inhale' ? 'scale-100 opacity-50' :
            phase === 'hold' ? 'scale-110 opacity-70' :
                'scale-90 opacity-30'} ${getColor()}`}/>
          ...
          <div className="flex justify-center gap-4">
            <Button onClick={toggleBreathing} className="gap-2" size="lg">
              {isActive ? (<>
            ...
            <Button variant="outline" onClick={resetBreathing} className="gap-2" size="lg">
