...
const EmergencyContacts = () => {
    ...
    return (<>
			<EmergencyFAB onAddContact={() => {
            setEditingContact(null);
            setIsAddModalOpen(true);
        }} onViewContacts={() => setIsViewModalOpen(true)} onPanicButton={() => setIsPanicModalOpen(true)}/>

			<AddContactModal isOpen={isAddModalOpen} onClose={() => {
            setIsAddModalOpen(false);
            setEditingContact(null);
        }} onSave={handleAddContact} editingContact={editingContact}/>

			<ViewContactsModal isOpen={isViewModalOpen} onClose={() => setIsViewModalOpen(false)} contacts={contacts} onEdit={handleEditContact} onDelete={handleDeleteContact}/>

			<PanicButtonModal isOpen={isPanicModalOpen} onClose={() => setIsPanicModalOpen(false)} onConfirm={handlePanicButton}/>
		</>);
};
