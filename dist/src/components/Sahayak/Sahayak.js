...
const Sahayak = () => {
    ...
    useEffect(() => {
        ...
        const dynamicStyles = clientWidth < 540
  ...
  document.body.appendChild(wrapDiv);
    ...
    return (<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="min-h-screen bg-gradient-to-br from-[#0A0F1C] to-[#1A1F3C] px-4 py-6 sm:p-6 text-white">
			<Button onClick={() => navigate('/dashboard')} className="mb-6 bg-white/5 backdrop-blur-lg border border-white/10 hover:bg-white/10 text-white">
				...
				<motion.div variants={item}>
					<Tabs defaultValue="therapists" className="w-full">
						<TabsList className="grid w-full grid-cols-3 bg-white/5 backdrop-blur-lg border border-white/10">
							<TabsTrigger value="therapists" className="data-[state=active]:bg-white/10 text-white data-[state=active]:text-white">
								Find Therapist
							</TabsTrigger>
							<TabsTrigger value="bookings" className="data-[state=active]:bg-white/10 text-white data-[state=active]:text-white">
								My Bookings
							</TabsTrigger>
							<TabsTrigger value="emergency" className="data-[state=active]:bg-white/10 text-white data-[state=active]:text-white">
								Emergency Support
							</TabsTrigger>
						</TabsList>
