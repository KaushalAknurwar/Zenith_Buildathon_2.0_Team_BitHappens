...
import { Mic, Square, Play, Pause, Save, FastForward, Rewind, Trash2 } from 'lucide-react';
const VoiceEntry = () => {
    ...
    return (<div className="space-y-6">
      <div className="bg-white p-6 rounded-lg shadow-md">
        <div className="flex flex-col items-center space-y-4">
          <div className="flex items-center space-x-4">
            <Button onClick={isRecording ? stopRecording : startRecording} className={isRecording ? "bg-red-500 hover:bg-red-600" : "bg-duo-blue hover:bg-duo-blue/90"}>
              {isRecording ? (<>
            ...
            {isRecording && (<span className="text-red-500 animate-pulse">
      ...
      {transcript && (<div className="space-y-4">
          <h3 className="text-lg font-semibold">Transcript</h3>
          <Textarea value={transcript} onChange={(e) => setTranscript(e.target.value)} className="min-h-[150px]" placeholder="Your transcribed text will appear here..."/>
      ...
      {currentEmotion && (<div className="bg-duo-purple/10 p-4 rounded-lg">
