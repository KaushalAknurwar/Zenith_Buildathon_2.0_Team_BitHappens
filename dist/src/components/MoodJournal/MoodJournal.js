...
const MoodJournal = () => {
    ...
    return (<div className="w-full max-w-4xl mx-auto p-6 space-y-8">
      <JournalHeader />
          ...
          <Tabs defaultValue="text" className="w-full" onValueChange={setActiveTab}>
            ...
            <div className="mt-8 text-white">
              <TabsContent value="text" className="text-white">
                <TextEntry textEntry={textEntry} setTextEntry={setTextEntry} handleSaveEntry={handleSaveTextEntry}/>
              </TabsContent>

              <TabsContent value="art" className="text-white">
                <ArtEntry canvasRef={canvasRef} color={color} setColor={setColor} brushSize={brushSize} setBrushSize={setBrushSize} tool={tool} setTool={setTool} clearCanvas={clearCanvas} handleSaveArtwork={handleSaveArtwork} title={title} setTitle={setTitle} description={description} setDescription={setDescription} privacy={privacy} setPrivacy={setPrivacy} startDrawing={startDrawing} draw={draw} stopDrawing={stopDrawing}/>
              </TabsContent>
