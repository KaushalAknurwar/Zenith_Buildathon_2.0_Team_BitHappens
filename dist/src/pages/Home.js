...
const Home = () => {
    ...
    return (<div className="min-h-screen bg-[#1A1A2E] flex flex-col relative overflow-x-hidden font-['Comic Sans MS']">
      <Header />
      <main className="flex-grow">
        <WavyBackground className="max-w-4xl mx-auto py-32 mt-20" colors={["#8B5CF6", "#D946EF", "#38bdf8"]} backgroundFill="#1A1A2E">
          ...
          <div className="flex justify-center animate-fade-in delay-200">
            <Button onClick={() => navigate('/dashboard')} className="bg-white/10 backdrop-blur-md border border-white/20 
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["About Us", "Features", "Blog", "Contact"].map((item) => (<li key={item}>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["Privacy Policy", "Terms of Service"].map((item) => (<li key={item}>
                    <a href="#" className="text-white/60 hover:text-white transition-colors">
                      {item}
                    </a>
                  </li>))}
            ...
            <div>
              ...
              <div className="space-y-4">
                <Input type="email" placeholder="Enter your email" className="bg-white/5 border-white/10 text-white placeholder:text-white/40"/>
                <Button onClick={() => navigate('/dashboard')} className="w-full bg-white/10 backdrop-blur-md border border-white/20 
                                hover:bg-white/20 transition-all duration-300 text-white">
                  Subscribe
